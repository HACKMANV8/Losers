...
class PassSequenceGenerator:
    ...
    def generate_random_sequence(self, min_length: int = 3, max_length: int = 15) -> List[str]:
        """Generate a random pass sequence."""
        length = random.randint(min_length, max_length)
        return random.choices(self.ALL_PASSES, k=length)
    
    def generate_stratified_sequence(self, min_length: int = 5, max_length: int = 12) -> List[str]:
        """
    ...
    def generate_synergy_based_sequence(self, num_synergies: int = 2, extra_passes: int = 3) -> List[str]:
        """
        ...
        selected_synergies = random.sample(self.PASS_SYNERGIES, min(num_synergies, len(self.PASS_SYNERGIES)))
    ...
    def generate_mutated_sequence(self, base_sequence: List[str], mutation_rate: float = 0.3) -> List[str]:
        """
